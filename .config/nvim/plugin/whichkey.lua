...
local mappings = {
	...
	s = {
		...
		g = { "<cmd> Telescop live_grep<cr>", "Find" },
		r = { "<cmd> Telescop lsp_references<cr>", "Find" },
		d = { "<cmd> Telescop diagnostics<cr>", "Find" },
	...
	d = {
		...
		h = { "<cmd>lua vim.diagnostic.open_float()<cr>", "Open_float" },
	},
}
